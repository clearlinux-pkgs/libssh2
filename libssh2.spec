...
Source0  : https://www.libssh2.org/download/libssh2-1.11.1.tar.gz
Source1  : https://www.libssh2.org/download/libssh2-1.11.1.tar.gz.asc
...
%setup -q -n libssh2-1.11.1
cd %{_builddir}/libssh2-1.11.1
pushd ..
cp -a libssh2-1.11.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729086401
...
/usr/share/man/man3/libssh2_session_callback_set2.3
...
/usr/share/man/man3/libssh2_sftp_posix_rename.3
/usr/share/man/man3/libssh2_sftp_posix_rename_ex.3
